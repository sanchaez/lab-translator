...
template <class T>
inline void fixed_width_print_obj(T obj, const int& width = 15, std::ostream &output = std::cout) {
...
void fixed_width_print_line(std::initializer_list<T> list,
                            const int& width = 15, std::ostream &output = std::cout) {
  for (T obj : list) {
...
template <typename T>
void fixed_width_print_line(T list, const int& width = 15, std::ostream &output = std::cout) {
...
template <typename T>
void fixed_width_print_matrix(T matrix, const int& width = 10, std::ostream &output = std::cout) {
